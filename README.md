...
<table>
    <tr>
      <td>
        <img src="output_example_demo/slideExample1/SlideExample_mini_1.jpg" alt="Example 1 - Histological Slide (.TIF)" width="300" height="200">
        <br>
        Example 1 - Histological Slide (.TIF)
      </td>
      <td>
        <img src="output_example_demo/slideExample1/SlideExample_mini_1_seg.jpg" alt="Example 1 - Segmented Slide (.TIF)" width="300" height="200">
        <br>
