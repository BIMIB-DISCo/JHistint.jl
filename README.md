...
## Running DEMO
The input files used by the demo are available in the `docs/readme_input_example` directory. The output files generated will also be saved in the related directory.  
If you want to access the demo output files directly without running it, they are available in the `docs/readme_output_example` directory. Follow the steps below to start the demo:
...
<table align="center">
 ...
 <table align="center">
    <tr>
      <td>
        <img src="docs/readme_output_example/slideExample2/SlideExample_mini_2.png" alt="Example 2 - Histological Slide (.TIF)" width="300" height="200">
        <br>
        Example 2 - Histological Slide (.TIF)
      </td>
      <td>
        <img src="docs/readme_output_example/slideExample2/SlideExample_mini_2_seg.png" alt="Example 2 - Segmented Slide (.TIF)" width="300" height="200">
        <br>
 ...
 <table align="center">
    <tr>
      <td>
        <img src="docs/readme_output_example/slideExample3/SlideExample_mini_3.png" alt="Example 3 - Histological Slide (.TIF)" width="300" height="200">
        <br>
        Example 3 - Histological Slide (.TIF)
      </td>
      <td>
        <img src="docs/readme_output_example/slideExample3/SlideExample_mini_3_seg.png" alt="Example 3 - Segmented Slide (.TIF)" width="300" height="200">
        <br>
...
The state of the lattice at any time of the simulation for the first example is provided below:  
 <table align="center">
    <tr>
      <td>
