...
<table align="center">
 ...
 <table align="center">
    <tr>
      <td>
        <img src="output_example_demo/slideExample1/SlideExample_mini_1_Plots_JSpace/Conf_t_10.png" alt="Example 1 - State of the lattice at t = 10" width="400" height="400">
        <br>
        Example 1 - State of the lattice at t = 10
      </td>
      <td>
        <img src="output_example_demo/slideExample1/SlideExample_mini_1_Plots_JSpace/Conf_t_20.png" alt=Example 1 - State of the lattice at t = 20" width="400" height="400">
        <br>
        Example 1 - State of the lattice at t = 20
      </td>
      <td>
        <img src="output_example_demo/slideExample1/SlideExample_mini_1_Plots_JSpace/Final_conf.png" alt=Example 1 - State of the lattice at final t" width="400" height="400">
        <br>
